...
var NavBar = React.createClass({
    ...
    render: function () {
        ...
        return <nav>
            <ul>
                <li className={name === '/profile'?'profile' + activate:'profile'}><Link to="profile"><span><span>Profile</span></span></Link></li>
                <li className={name === '/resume'?'resume' + activate:'resume'}><Link to="resume"><span><span>Resume</span></span></Link></li>
                <li className={name === '/education'?'education' + activate:'education'}><Link to="education"><span><span>Education</span></span></Link></li>
